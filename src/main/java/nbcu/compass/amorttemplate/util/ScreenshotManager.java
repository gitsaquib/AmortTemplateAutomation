...
public class ScreenshotManager {
	...
	public static void takeScreenshot(WebDriver driver, String filepath) {
		File screenshot = null;
		    //Checking AWS system property to check whether test is running from AWS or local
			if (System.getProperty("appium.screenshots.dir") != null) {
				String screenshotDirectory = System.getProperty("appium.screenshots.dir", System.getProperty("java.io.tmpdir", ""));
				screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
				screenshot.renameTo(new File(screenshotDirectory, String.format("%s.png", "Screenshot_" + screenShotIndex.incrementAndGet())));
		} else {
